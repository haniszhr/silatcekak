...
<section>
    ...
    <center>
       <form action="displayform2.php" method="post">
...
<tr>
    <td>Name:</td>
    <td> <?php echo $_POST["name"]; ?><input type=
        text"><br></td>
</tr>
<tr>
    <td>Email:</td>
...
<tr>
    <td>Address:</td>
    <td> <?php echo $_POST["address"]; ?><br></td></tr>
<tr>
        <td>Gender:</td>
        <td> <?php echo $_POST["gender"]; ?>
<tr>
        <td>Comment:</td>
        <td> <?php echo $_POST["comment"]; ?></td> </tr>
 <tr>
        <td><strong>Favourite Site:</strong></td>
        <td style = "text-align:left">
        <?php echo $_POST["favepage"]; ?><br><br>
       </td></tr>
    <tr>
      <th colspan="2">  
        <input type = "button" onClick="myFunction()" value = "Process Form" >
